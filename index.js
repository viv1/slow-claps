//
// Alexa Fact Skill - Play Slow Claps
//
...
const ExitHandler = {
  ...
  handle(handlerInput) {
    ...
    return handlerInput.responseBuilder
      ...
      .reprompt(requestAttributes.t('STOP_MESSAGE'))
      .getResponse();
  },
};
...
const enData = {
  translation: {
    SKILL_NAME: 'Slow Claps',
    HELP_MESSAGE: 'Ask me to start slow claps',
    HELP_REPROMPT: 'Ask me to start slow claps',
    FALLBACK_MESSAGE: 'Ask me to start slow claps',
    FALLBACK_REPROMPT: 'Ask me to start slow claps',
